...
stat(char *n, struct stat *st)
{
 ...
 340:	eb0000db 	bl	6b4 <fstat>
 344:	e1a04000 	mov	r4, r0
  close(fd);
 348:	e1a00005 	mov	r0, r5
 34c:	eb00008a 	bl	57c <close>
  return r;
}
