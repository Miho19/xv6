   ...
   0:	e3500001 	cmp	r0, #1
{
  ...
  10:	e3007b60 	movw	r7, #2912	; 0xb60
  14:	e3006b64 	movw	r6, #2916	; 0xb64
  ...
  38:	eb000202 	bl	848 <printf>
  3c:	e4942004 	ldr	r2, [r4], #4
  40:	e1540005 	cmp	r4, r5
  44:	1afffff8 	bne	2c <main+0x2c>
  48:	e3003b6c 	movw	r3, #2924	; 0xb6c
  4c:	e3001b64 	movw	r1, #2916	; 0xb64
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 740:	e28db020 	add	fp, sp, #32
  ...
  neg = 0;
  if(sgn && xx < 0){
 744:	e013afa1 	ands	sl, r3, r1, lsr #31
 748:	e24b4034 	sub	r4, fp, #52	; 0x34
 74c:	e3009b70 	movw	r9, #2928	; 0xb70
    neg = 1;
    x = -xx;
 ...
 754:	e3409000 	movt	r9, #0
{
 ...
 760:	01a0e001 	moveq	lr, r1
  ...
  b = base;
  i = 0;
 764:	e3a08000 	mov	r8, #0
  b = base;
 768:	e1a07004 	mov	r7, r4
            q = q | (1 << i);
 76c:	e3a06001 	mov	r6, #1
{
 ...
 78c:	e1520001 	cmp	r2, r1
            r = r - d;
 790:	90411002 	subls	r1, r1, r2
            q = q | (1 << i);
 794:	918cc316 	orrls	ip, ip, r6, lsl r3
    for(i=31;i>=0;i--){
 798:	e2533001 	subs	r3, r3, #1
 79c:	2afffff7 	bcs	780 <printint+0x44>
  do{
    y = div(x, b);
    buf[i++] = digits[x - y * b];
 7a0:	e061e29c 	mls	r1, ip, r2, lr
  }while((x = y) != 0);
 7a4:	e35c0000 	cmp	ip, #0
 7a8:	e1a0e00c 	mov	lr, ip
    buf[i++] = digits[x - y * b];
 7ac:	e2883001 	add	r3, r8, #1
 7b0:	e7d91001 	ldrb	r1, [r9, r1]
 7b4:	e4c71001 	strb	r1, [r7], #1
 7b8:	11a08003 	movne	r8, r3
 7bc:	1affffec 	bne	774 <printint+0x38>
  if(neg)
 7c0:	e35a0000 	cmp	sl, #0
 7c4:	0a000004 	beq	7dc <printint+0xa0>
    buf[i++] = '-';
 7c8:	e24b2024 	sub	r2, fp, #36	; 0x24
 7cc:	e3a0102d 	mov	r1, #45	; 0x2d
 7d0:	e0822003 	add	r2, r2, r3
 7d4:	e2883002 	add	r3, r8, #2
 7d8:	e5421010 	strb	r1, [r2, #-16]
 7dc:	e0846003 	add	r6, r4, r3
 7e0:	e5763001 	ldrb	r3, [r6, #-1]!
  write(fd, &c, 1);
 7e4:	e3a02001 	mov	r2, #1
 7e8:	e24b1035 	sub	r1, fp, #53	; 0x35
 7ec:	e1a00005 	mov	r0, r5
 7f0:	e54b3035 	strb	r3, [fp, #-53]	; 0xffffffcb
 7f4:	ebffff00 	bl	3fc <write>

  while(--i >= 0)
 7f8:	e1540006 	cmp	r4, r6
 7fc:	1afffff7 	bne	7e0 <printint+0xa4>
    putc(fd, buf[i]);
}
...
printf(int fd, char *fmt, ...)
{
 ...
 854:	e24dd008 	sub	sp, sp, #8
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
 858:	e59b5004 	ldr	r5, [fp, #4]
 85c:	e5d54000 	ldrb	r4, [r5]
 ...
 894:	ebfffed8 	bl	3fc <write>
  for(i = 0; fmt[i]; i++){
 898:	e5f54001 	ldrb	r4, [r5, #1]!
 ...
 8ac:	e3560025 	cmp	r6, #37	; 0x25
 8b0:	1afffff8 	bne	898 <printf+0x50>
      if(c == 'd'){
 8b4:	e3540064 	cmp	r4, #100	; 0x64
 8b8:	0a000030 	beq	980 <printf+0x138>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
 ...
 8dc:	0a00002e 	beq	99c <printf+0x154>
  write(fd, &c, 1);
 8e0:	e3a02001 	mov	r2, #1
 8e4:	e24b1019 	sub	r1, fp, #25
 8e8:	e1a00007 	mov	r0, r7
 8ec:	e54b6019 	strb	r6, [fp, #-25]	; 0xffffffe7
 8f0:	ebfffec1 	bl	3fc <write>
 ...
 968:	e54b601d 	strb	r6, [fp, #-29]	; 0xffffffe3
 96c:	ebfffea2 	bl	3fc <write>
        while(*s != 0){
 970:	e5f46001 	ldrb	r6, [r4, #1]!
 ...
 988:	e4981004 	ldr	r1, [r8], #4
 98c:	e1a00007 	mov	r0, r7
 990:	ebffff69 	bl	73c <printint>
      state = 0;
 ...
 9a8:	e5616003 	strb	r6, [r1, #-3]!
      state = 0;
 9ac:	e3a06000 	mov	r6, #0
  write(fd, &c, 1);
 9b0:	ebfffe91 	bl	3fc <write>
 ...
 9cc:	e5613004 	strb	r3, [r1, #-4]!
  write(fd, &c, 1);
 9d0:	ebfffe89 	bl	3fc <write>
 9d4:	eaffffaf 	b	898 <printf+0x50>
          s = "(null)";
 9d8:	e3004b84 	movw	r4, #2948	; 0xb84
        while(*s != 0){
 9dc:	e3a06028 	mov	r6, #40	; 0x28
          s = "(null)";
...
free(void *ap)
{
 ...
 9e8:	e300cb8c 	movw	ip, #2956	; 0xb8c
 ...
 9f8:	e59c3000 	ldr	r3, [ip]
{
 ...
 a70:	3a000001 	bcc	a7c <free+0x94>
 a74:	e1510002 	cmp	r1, r2
 a78:	3affffe7 	bcc	a1c <free+0x34>
{
 a7c:	e1a03002 	mov	r3, r2
 a80:	eaffffde 	b	a00 <free+0x18>
...
malloc(uint nbytes)
{
 a84:	e92d48f0 	push	{r4, r5, r6, r7, fp, lr}
  ...
  if((prevp = freep) == 0){
 a88:	e3007b8c 	movw	r7, #2956	; 0xb8c
 ...
 a90:	e2804007 	add	r4, r0, #7
{
 ...
 adc:	2a000010 	bcs	b24 <malloc+0xa0>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
