...
stat(char *n, struct stat *st)
{
 ...
 228:	eb0000db 	bl	59c <fstat>
 22c:	e1a04000 	mov	r4, r0
  close(fd);
 230:	e1a00005 	mov	r0, r5
 234:	eb00008a 	bl	464 <close>
  return r;
}
