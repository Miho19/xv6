     ...
     170:	e2504000 	subs	r4, r0, #0
{
  ...
  if(pid == -1)
    ...
    close(p[0]);
     ...
     260:	eb000342 	bl	f70 <close>
    close(p[1]);
     264:	e51b0010 	ldr	r0, [fp, #-16]
     268:	eb000340 	bl	f70 <close>
    wait();
  ...
  if(pid == -1)
    ...
    panic("fork");
     ...
     2ac:	ebffffa6 	bl	14c <panic>
      close(0);
     2b0:	eb00032e 	bl	f70 <close>
      dup(p[0]);
     2b4:	e51b0014 	ldr	r0, [fp, #-20]	; 0xffffffec
     2b8:	eb0003ae 	bl	1178 <dup>
      close(p[0]);
     2bc:	e51b0014 	ldr	r0, [fp, #-20]	; 0xffffffec
     2c0:	eb00032a 	bl	f70 <close>
      close(p[1]);
     2c4:	e51b0010 	ldr	r0, [fp, #-16]
     2c8:	eb000328 	bl	f70 <close>
      runcmd(pcmd->right);
     ...
     2e4:	eb000321 	bl	f70 <close>
      dup(p[1]);
     2e8:	e51b0010 	ldr	r0, [fp, #-16]
     2ec:	eb0003a1 	bl	1178 <dup>
      close(p[0]);
     2f0:	e51b0014 	ldr	r0, [fp, #-20]	; 0xffffffec
     2f4:	eb00031d 	bl	f70 <close>
      close(p[1]);
     2f8:	e51b0010 	ldr	r0, [fp, #-16]
     2fc:	eb00031b 	bl	f70 <close>
      runcmd(pcmd->left);
...
stat(char *n, struct stat *st)
{
  ...
  r = fstat(fd, st);
     ...
     d34:	eb0000db 	bl	10a8 <fstat>
     d38:	e1a04000 	mov	r4, r0
  close(fd);
     d3c:	e1a00005 	mov	r0, r5
     d40:	eb00008a 	bl	f70 <close>
  return r;
}
