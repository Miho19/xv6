  ...
  4c:	e3000828 	movw	r0, #2088	; 0x828
{
  ...
  write(fd, s, strlen(s));
  bc:	e300085c 	movw	r0, #2140	; 0x85c
  c0:	e3400000 	movt	r0, #0
  c4:	eb00003c 	bl	1bc <strlen>
  c8:	e300185c 	movw	r1, #2140	; 0x85c
...
stat(char *n, struct stat *st)
{
 ...
 314:	eb0000ce 	bl	654 <fstat>
 318:	e1a04000 	mov	r4, r0
  close(fd);
 31c:	e1a00005 	mov	r0, r5
 320:	eb00007d 	bl	51c <close>
  return r;
}
