...
stat(char *n, struct stat *st)
{
 ...
 314:	eb0000db 	bl	688 <fstat>
 318:	e1a04000 	mov	r4, r0
  close(fd);
 31c:	e1a00005 	mov	r0, r5
 320:	eb00008a 	bl	550 <close>
  return r;
}
