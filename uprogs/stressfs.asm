...
stat(char *n, struct stat *st)
{
 ...
 2d0:	eb0000db 	bl	644 <fstat>
 2d4:	e1a04000 	mov	r4, r0
  close(fd);
 2d8:	e1a00005 	mov	r0, r5
 2dc:	eb00008a 	bl	50c <close>
  return r;
}
