   ...
   0:	e3500001 	cmp	r0, #1
{
  ...
  28:	eb000145 	bl	544 <exit>
    ls(".");
  2c:	e3000df8 	movw	r0, #3576	; 0xdf8
...
0000003c <fmtname>:
{
  ...
  a0:	e3005e18 	movw	r5, #3608	; 0xe18
  ...
  f0:	e3a01000 	mov	r1, #0
{
 ...
 14c:	e3001dac 	movw	r1, #3500	; 0xdac
 150:	e3401000 	movt	r1, #0
 154:	eb00024e 	bl	a94 <printf>
}
 ...
 1e8:	e3008dd4 	movw	r8, #3540	; 0xdd4
        printf(1, "ls: cannot stat %s\n", buf);
 1ec:	e300adc0 	movw	sl, #3520	; 0xdc0
    strcpy(buf, path);
...
{
 988:	e92d4ff0 	push	{r4, r5, r6, r7, r8, r9, sl, fp, lr}
 98c:	e28db020 	add	fp, sp, #32
  char buf[16];
  int i, neg;
  uint x, y, b;
  ...
  neg = 0;
  if(sgn && xx < 0){
 990:	e013afa1 	ands	sl, r3, r1, lsr #31
 994:	e24b4034 	sub	r4, fp, #52	; 0x34
 998:	e3009dfc 	movw	r9, #3580	; 0xdfc
    neg = 1;
    x = -xx;
 99c:	1261e000 	rsbne	lr, r1, #0
 9a0:	e3409000 	movt	r9, #0
{
 9a4:	e1a05000 	mov	r5, r0
    neg = 1;
 9a8:	13a0a001 	movne	sl, #1
  } else {
    x = xx;
 9ac:	01a0e001 	moveq	lr, r1
  }

  b = base;
  i = 0;
 9b0:	e3a08000 	mov	r8, #0
  b = base;
 9b4:	e1a07004 	mov	r7, r4
            q = q | (1 << i);
 9b8:	e3a06001 	mov	r6, #1
{
 9bc:	e24dd01c 	sub	sp, sp, #28
    u32 q=0, r=0;
 9c0:	e3a0c000 	mov	ip, #0
    for(i=31;i>=0;i--){
 9c4:	e3a0301f 	mov	r3, #31
    u32 q=0, r=0;
 9c8:	e1a0100c 	mov	r1, ip
        r = r | ((n >> i) & 1);
 9cc:	e1a0033e 	lsr	r0, lr, r3
 9d0:	e2000001 	and	r0, r0, #1
 9d4:	e1801081 	orr	r1, r0, r1, lsl #1
        if(r >= d) {
 9d8:	e1520001 	cmp	r2, r1
            r = r - d;
 9dc:	90411002 	subls	r1, r1, r2
            q = q | (1 << i);
 9e0:	918cc316 	orrls	ip, ip, r6, lsl r3
    for(i=31;i>=0;i--){
 9e4:	e2533001 	subs	r3, r3, #1
 9e8:	2afffff7 	bcs	9cc <printint+0x44>
  do{
    y = div(x, b);
    buf[i++] = digits[x - y * b];
 9ec:	e061e29c 	mls	r1, ip, r2, lr
  }while((x = y) != 0);
 9f0:	e35c0000 	cmp	ip, #0
 9f4:	e1a0e00c 	mov	lr, ip
    buf[i++] = digits[x - y * b];
 9f8:	e2883001 	add	r3, r8, #1
 9fc:	e7d91001 	ldrb	r1, [r9, r1]
 a00:	e4c71001 	strb	r1, [r7], #1
 a04:	11a08003 	movne	r8, r3
 a08:	1affffec 	bne	9c0 <printint+0x38>
  if(neg)
 a0c:	e35a0000 	cmp	sl, #0
 a10:	0a000004 	beq	a28 <printint+0xa0>
    buf[i++] = '-';
 a14:	e24b2024 	sub	r2, fp, #36	; 0x24
 a18:	e3a0102d 	mov	r1, #45	; 0x2d
 a1c:	e0822003 	add	r2, r2, r3
 a20:	e2883002 	add	r3, r8, #2
 a24:	e5421010 	strb	r1, [r2, #-16]
 a28:	e0846003 	add	r6, r4, r3
 a2c:	e5763001 	ldrb	r3, [r6, #-1]!
  write(fd, &c, 1);
 a30:	e3a02001 	mov	r2, #1
 a34:	e24b1035 	sub	r1, fp, #53	; 0x35
 a38:	e1a00005 	mov	r0, r5
 a3c:	e54b3035 	strb	r3, [fp, #-53]	; 0xffffffcb
 a40:	ebffff00 	bl	648 <write>

  while(--i >= 0)
 a44:	e1540006 	cmp	r4, r6
 a48:	1afffff7 	bne	a2c <printint+0xa4>
    putc(fd, buf[i]);
}
 a4c:	e24bd020 	sub	sp, fp, #32
 a50:	e8bd8ff0 	pop	{r4, r5, r6, r7, r8, r9, sl, fp, pc}
...
{
 a5c:	e28db008 	add	fp, sp, #8
 a60:	e1a0e000 	mov	lr, r0
    for(i=31;i>=0;i--){
 a64:	e3a0301f 	mov	r3, #31
    u32 q=0, r=0;
 a68:	e1a00002 	mov	r0, r2
            q = q | (1 << i);
 a6c:	e3a04001 	mov	r4, #1
        r = r | ((n >> i) & 1);
 a70:	e1a0c33e 	lsr	ip, lr, r3
 a74:	e20cc001 	and	ip, ip, #1
 a78:	e18c2082 	orr	r2, ip, r2, lsl #1
        if(r >= d) {
 a7c:	e1520001 	cmp	r2, r1
            r = r - d;
 a80:	20422001 	subcs	r2, r2, r1
            q = q | (1 << i);
 a84:	21800314 	orrcs	r0, r0, r4, lsl r3
    for(i=31;i>=0;i--){
 a88:	e2533001 	subs	r3, r3, #1
 a8c:	38bd8810 	popcc	{r4, fp, pc}
 a90:	eafffff6 	b	a70 <div+0x1c>
...
{
 a94:	e92d000e 	push	{r1, r2, r3}
 a98:	e92d49f0 	push	{r4, r5, r6, r7, r8, fp, lr}
 a9c:	e28db018 	add	fp, sp, #24
 aa0:	e24dd008 	sub	sp, sp, #8
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
 aa4:	e59b5004 	ldr	r5, [fp, #4]
 aa8:	e5d54000 	ldrb	r4, [r5]
 aac:	e3540000 	cmp	r4, #0
 ab0:	0a00002b 	beq	b64 <printf+0xd0>
 ab4:	e1a07000 	mov	r7, r0
  ap = (uint*)(void*)&fmt + 1;
 ab8:	e28b8008 	add	r8, fp, #8
  state = 0;
 abc:	e3a06000 	mov	r6, #0
 ac0:	ea00000a 	b	af0 <printf+0x5c>
    c = fmt[i] & 0xff;
    if(state == 0){
      if(c == '%'){
 ac4:	e3540025 	cmp	r4, #37	; 0x25
        state = '%';
 ac8:	01a06004 	moveq	r6, r4
      if(c == '%'){
 acc:	0a000004 	beq	ae4 <printf+0x50>
 ad0:	e24b1018 	sub	r1, fp, #24
  write(fd, &c, 1);
 ad4:	e3a02001 	mov	r2, #1
 ad8:	e1a00007 	mov	r0, r7
 adc:	e5614006 	strb	r4, [r1, #-6]!
 ae0:	ebfffed8 	bl	648 <write>
  for(i = 0; fmt[i]; i++){
 ae4:	e5f54001 	ldrb	r4, [r5, #1]!
 ae8:	e3540000 	cmp	r4, #0
 aec:	0a00001c 	beq	b64 <printf+0xd0>
    if(state == 0){
 af0:	e3560000 	cmp	r6, #0
 af4:	0afffff2 	beq	ac4 <printf+0x30>
      } else {
        putc(fd, c);
      }
    } else if(state == '%'){
 af8:	e3560025 	cmp	r6, #37	; 0x25
 afc:	1afffff8 	bne	ae4 <printf+0x50>
      if(c == 'd'){
 b00:	e3540064 	cmp	r4, #100	; 0x64
 b04:	0a000030 	beq	bcc <printf+0x138>
        printint(fd, *ap, 10, 1);
        ap++;
      } else if(c == 'x' || c == 'p'){
 b08:	e20430f7 	and	r3, r4, #247	; 0xf7
 b0c:	e3530070 	cmp	r3, #112	; 0x70
 b10:	0a000017 	beq	b74 <printf+0xe0>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
 b14:	e3540073 	cmp	r4, #115	; 0x73
 b18:	0a00001c 	beq	b90 <printf+0xfc>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
 ...
 b1c:	e3540063 	cmp	r4, #99	; 0x63
 b20:	0a000037 	beq	c04 <printf+0x170>
        putc(fd, *ap);
        ap++;
      } else if(c == '%'){
 b24:	e3540025 	cmp	r4, #37	; 0x25
 b28:	0a00002e 	beq	be8 <printf+0x154>
  write(fd, &c, 1);
 b2c:	e3a02001 	mov	r2, #1
 b30:	e24b1019 	sub	r1, fp, #25
 b34:	e1a00007 	mov	r0, r7
 b38:	e54b6019 	strb	r6, [fp, #-25]	; 0xffffffe7
 b3c:	ebfffec1 	bl	648 <write>
 b40:	e3a02001 	mov	r2, #1
 b44:	e24b101a 	sub	r1, fp, #26
 b48:	e1a00007 	mov	r0, r7
 b4c:	e54b401a 	strb	r4, [fp, #-26]	; 0xffffffe6
 b50:	ebfffebc 	bl	648 <write>
  for(i = 0; fmt[i]; i++){
 b54:	e5f54001 	ldrb	r4, [r5, #1]!
      } else {
      ...
      state = 0;
 b58:	e3a06000 	mov	r6, #0
  for(i = 0; fmt[i]; i++){
 b5c:	e3540000 	cmp	r4, #0
 b60:	1affffe2 	bne	af0 <printf+0x5c>
    }
  }
}
 b64:	e24bd018 	sub	sp, fp, #24
 b68:	e8bd49f0 	pop	{r4, r5, r6, r7, r8, fp, lr}
 b6c:	e28dd00c 	add	sp, sp, #12
 b70:	e12fff1e 	bx	lr
        printint(fd, *ap, 16, 0);
 b74:	e3a03000 	mov	r3, #0
 b78:	e3a02010 	mov	r2, #16
 b7c:	e4981004 	ldr	r1, [r8], #4
 b80:	e1a00007 	mov	r0, r7
 b84:	ebffff7f 	bl	988 <printint>
      state = 0;
 b88:	e3a06000 	mov	r6, #0
 b8c:	eaffffd4 	b	ae4 <printf+0x50>
        s = (char*)*ap;
 b90:	e4984004 	ldr	r4, [r8], #4
        if(s == 0)
 b94:	e3540000 	cmp	r4, #0
 b98:	0a000021 	beq	c24 <printf+0x190>
        while(*s != 0){
 b9c:	e5d46000 	ldrb	r6, [r4]
 ba0:	e3560000 	cmp	r6, #0
 ba4:	0affffce 	beq	ae4 <printf+0x50>
  write(fd, &c, 1);
 ba8:	e3a02001 	mov	r2, #1
 bac:	e24b101d 	sub	r1, fp, #29
 bb0:	e1a00007 	mov	r0, r7
 bb4:	e54b601d 	strb	r6, [fp, #-29]	; 0xffffffe3
 bb8:	ebfffea2 	bl	648 <write>
        while(*s != 0){
 bbc:	e5f46001 	ldrb	r6, [r4, #1]!
 bc0:	e3560000 	cmp	r6, #0
 bc4:	1afffff7 	bne	ba8 <printf+0x114>
 bc8:	eaffffc5 	b	ae4 <printf+0x50>
        printint(fd, *ap, 10, 1);
 bcc:	e3a03001 	mov	r3, #1
 bd0:	e3a0200a 	mov	r2, #10
 bd4:	e4981004 	ldr	r1, [r8], #4
 bd8:	e1a00007 	mov	r0, r7
 bdc:	ebffff69 	bl	988 <printint>
      state = 0;
 be0:	e3a06000 	mov	r6, #0
 be4:	eaffffbe 	b	ae4 <printf+0x50>
 be8:	e24b1018 	sub	r1, fp, #24
  write(fd, &c, 1);
 bec:	e3a02001 	mov	r2, #1
 bf0:	e1a00007 	mov	r0, r7
 bf4:	e5616003 	strb	r6, [r1, #-3]!
      state = 0;
 bf8:	e3a06000 	mov	r6, #0
  write(fd, &c, 1);
 bfc:	ebfffe91 	bl	648 <write>
 c00:	eaffffb7 	b	ae4 <printf+0x50>
        putc(fd, *ap);
 c04:	e4983004 	ldr	r3, [r8], #4
 c08:	e24b1018 	sub	r1, fp, #24
  write(fd, &c, 1);
 c0c:	e3a02001 	mov	r2, #1
 c10:	e1a00007 	mov	r0, r7
      state = 0;
 c14:	e3a06000 	mov	r6, #0
        putc(fd, *ap);
 c18:	e5613004 	strb	r3, [r1, #-4]!
  write(fd, &c, 1);
 c1c:	ebfffe89 	bl	648 <write>
 c20:	eaffffaf 	b	ae4 <printf+0x50>
          s = "(null)";
 c24:	e3004e10 	movw	r4, #3600	; 0xe10
        while(*s != 0){
 c28:	e3a06028 	mov	r6, #40	; 0x28
          s = "(null)";
 c2c:	e3404000 	movt	r4, #0
 c30:	eaffffdc 	b	ba8 <printf+0x114>
...
free(void *ap)
{
 ...
 c34:	e300ce28 	movw	ip, #3624	; 0xe28
 c38:	e340c000 	movt	ip, #0
{
 c3c:	e92d4810 	push	{r4, fp, lr}
  bp = (Header*)ap - 1;
 c40:	e2401008 	sub	r1, r0, #8
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 c44:	e59c3000 	ldr	r3, [ip]
{
 c48:	e28db008 	add	fp, sp, #8
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
 c4c:	e1530001 	cmp	r3, r1
 c50:	e5932000 	ldr	r2, [r3]
 c54:	2a000017 	bcs	cb8 <free+0x84>
 c58:	e1510002 	cmp	r1, r2
 c5c:	3a000001 	bcc	c68 <free+0x34>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 c60:	e1530002 	cmp	r3, r2
 c64:	3a000017 	bcc	cc8 <free+0x94>
      break;
  if(bp + bp->s.size == p->s.ptr){
 c68:	e510e004 	ldr	lr, [r0, #-4]
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    p->s.ptr = bp->s.ptr;
  } else
    p->s.ptr = bp;
  freep = p;
 c6c:	e58c3000 	str	r3, [ip]
  if(bp + bp->s.size == p->s.ptr){
 c70:	e081418e 	add	r4, r1, lr, lsl #3
 c74:	e1520004 	cmp	r2, r4
    bp->s.size += p->s.ptr->s.size;
 c78:	05922004 	ldreq	r2, [r2, #4]
 c7c:	0082e00e 	addeq	lr, r2, lr
 c80:	0500e004 	streq	lr, [r0, #-4]
    bp->s.ptr = p->s.ptr->s.ptr;
 c84:	05932000 	ldreq	r2, [r3]
 c88:	05922000 	ldreq	r2, [r2]
    bp->s.ptr = p->s.ptr;
 c8c:	e5002008 	str	r2, [r0, #-8]
  if(p + p->s.size == bp){
 c90:	e5932004 	ldr	r2, [r3, #4]
 c94:	e083e182 	add	lr, r3, r2, lsl #3
 c98:	e151000e 	cmp	r1, lr
    p->s.ptr = bp;
 c9c:	15831000 	strne	r1, [r3]
    p->s.size += bp->s.size;
 ca0:	05101004 	ldreq	r1, [r0, #-4]
 ca4:	00812002 	addeq	r2, r1, r2
 ca8:	05832004 	streq	r2, [r3, #4]
    p->s.ptr = bp->s.ptr;
 cac:	05102008 	ldreq	r2, [r0, #-8]
 cb0:	05832000 	streq	r2, [r3]
}
 cb4:	e8bd8810 	pop	{r4, fp, pc}
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
 cb8:	e1530002 	cmp	r3, r2
 cbc:	3a000001 	bcc	cc8 <free+0x94>
 cc0:	e1510002 	cmp	r1, r2
 cc4:	3affffe7 	bcc	c68 <free+0x34>
{
 cc8:	e1a03002 	mov	r3, r2
 ccc:	eaffffde 	b	c4c <free+0x18>
...
malloc(uint nbytes)
{
 cd0:	e92d48f0 	push	{r4, r5, r6, r7, fp, lr}
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
  if((prevp = freep) == 0){
 cd4:	e3007e28 	movw	r7, #3624	; 0xe28
 cd8:	e3407000 	movt	r7, #0
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 cdc:	e2804007 	add	r4, r0, #7
{
 ce0:	e28db014 	add	fp, sp, #20
  if((prevp = freep) == 0){
 ce4:	e5973000 	ldr	r3, [r7]
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ce8:	e1a041a4 	lsr	r4, r4, #3
 cec:	e2844001 	add	r4, r4, #1
  if((prevp = freep) == 0){
 cf0:	e3530000 	cmp	r3, #0
 cf4:	0a000027 	beq	d98 <malloc+0xc8>
 cf8:	e5930000 	ldr	r0, [r3]
 cfc:	e5902004 	ldr	r2, [r0, #4]
 ...
 d04:	9a000019 	bls	d70 <malloc+0xa0>
 d08:	e3540a01 	cmp	r4, #4096	; 0x1000
 d0c:	21a05004 	movcs	r5, r4
 d10:	33a05a01 	movcc	r5, #4096	; 0x1000
  p = sbrk(nu * sizeof(Header));
 d14:	e1a06185 	lsl	r6, r5, #3
 d18:	ea000003 	b	d2c <malloc+0x5c>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 d1c:	e5930000 	ldr	r0, [r3]
    if(p->s.size >= nunits){
 d20:	e5902004 	ldr	r2, [r0, #4]
 d24:	e1520004 	cmp	r2, r4
 d28:	2a000010 	bcs	d70 <malloc+0xa0>
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
 d2c:	e5972000 	ldr	r2, [r7]
 d30:	e1a03000 	mov	r3, r0
 d34:	e1520000 	cmp	r2, r0
 d38:	1afffff7 	bne	d1c <malloc+0x4c>
  p = sbrk(nu * sizeof(Header));
 d3c:	e1a00006 	mov	r0, r6
 d40:	ebfffee9 	bl	8ec <sbrk>
 ...
 d4c:	e2800008 	add	r0, r0, #8
  if(p == (char*)-1)
 d50:	0a000004 	beq	d68 <malloc+0x98>
  hp->s.size = nu;
 d54:	e5835004 	str	r5, [r3, #4]
  free((void*)(hp + 1));
 d58:	ebffffb5 	bl	c34 <free>
  return freep;
 d5c:	e5973000 	ldr	r3, [r7]
      if((p = morecore(nunits)) == 0)
 d60:	e3530000 	cmp	r3, #0
 d64:	1affffec 	bne	d1c <malloc+0x4c>
        return 0;
 d68:	e3a00000 	mov	r0, #0
  }
}
 d6c:	e8bd88f0 	pop	{r4, r5, r6, r7, fp, pc}
      if(p->s.size == nunits)
 d70:	e1540002 	cmp	r4, r2
      freep = prevp;
 d74:	e5873000 	str	r3, [r7]
        p->s.size -= nunits;
 d78:	10422004 	subne	r2, r2, r4
 ...
 d90:	05832000 	streq	r2, [r3]
      return (void*)(p + 1);
 d94:	e8bd88f0 	pop	{r4, r5, r6, r7, fp, pc}
    base.s.ptr = freep = prevp = &base;
 d98:	e2870004 	add	r0, r7, #4
    base.s.size = 0;
 d9c:	e5873008 	str	r3, [r7, #8]
    base.s.ptr = freep = prevp = &base;
 da0:	e5870000 	str	r0, [r7]
 da4:	e5870004 	str	r0, [r7, #4]
 da8:	eaffffd6 	b	d08 <malloc+0x38>
