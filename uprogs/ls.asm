...
stat(char *n, struct stat *st)
{
 ...
 474:	eb0000db 	bl	7e8 <fstat>
 478:	e1a04000 	mov	r4, r0
  close(fd);
 47c:	e1a00005 	mov	r0, r5
 480:	eb00008a 	bl	6b0 <close>
  return r;
}
