...
stat(char *n, struct stat *st)
{
 ...
 4ec:	eb0000db 	bl	860 <fstat>
 4f0:	e1a04000 	mov	r4, r0
  close(fd);
 4f4:	e1a00005 	mov	r0, r5
 4f8:	eb00008a 	bl	728 <close>
  return r;
}
