...
stat(char *n, struct stat *st)
{
 ...
 210:	eb0000db 	bl	584 <fstat>
 214:	e1a04000 	mov	r4, r0
  close(fd);
 218:	e1a00005 	mov	r0, r5
 21c:	eb00008a 	bl	44c <close>
  return r;
}
