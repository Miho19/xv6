   ...
   4:	e3000c1c 	movw	r0, #3100	; 0xc1c
{
  ...
  dup(0);  // stdout
  28:	eb0001b1 	bl	6f4 <dup>
  dup(0);  // stderr
  2c:	e3a00000 	mov	r0, #0
  30:	eb0001af 	bl	6f4 <dup>
      exec("sh", argv);
...
stat(char *n, struct stat *st)
{
 ...
 2b0:	eb0000db 	bl	624 <fstat>
 2b4:	e1a04000 	mov	r4, r0
  close(fd);
 2b8:	e1a00005 	mov	r0, r5
 2bc:	eb00008a 	bl	4ec <close>
  return r;
}
