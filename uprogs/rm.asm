   ...
   0:	e3500001 	cmp	r0, #1
{
  ...
  48:	e3001b6c 	movw	r1, #2924	; 0xb6c
 ...
 730:	12099001 	andne	r9, r9, #1
{
 ...
 73c:	e3008b88 	movw	r8, #2952	; 0xb88
    neg = 1;
    x = -xx;
...
printf(int fd, char *fmt, ...)
{
 ...
 9cc:	eaffffaf 	b	890 <printf+0x50>
          s = "(null)";
 9d0:	e3004b9c 	movw	r4, #2972	; 0xb9c
        while(*s != 0){
...
free(void *ap)
{
 ...
 9e0:	e300cba4 	movw	ip, #2980	; 0xba4
...
malloc(uint nbytes)
{
 a7c:	e92d48f0 	push	{r4, r5, r6, r7, fp, lr}
  ...
  if((prevp = freep) == 0){
 a80:	e3007ba4 	movw	r7, #2980	; 0xba4
