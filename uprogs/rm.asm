   ...
   0:	e3500001 	cmp	r0, #1
{
  ...
  48:	e3001b9c 	movw	r1, #2972	; 0xb9c
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 764:	e3009bb8 	movw	r9, #3000	; 0xbb8
    neg = 1;
    x = -xx;
...
printf(int fd, char *fmt, ...)
{
 ...
 9f0:	eaffffb3 	b	8c4 <printf+0x50>
          s = "(null)";
 9f4:	e3004bcc 	movw	r4, #3020	; 0xbcc
        while(*s != 0){
...
free(void *ap)
{
 ...
 a04:	e300cbd4 	movw	ip, #3028	; 0xbd4
...
malloc(uint nbytes)
{
 aa0:	e92d48f0 	push	{r4, r5, r6, r7, fp, lr}
  ...
  if((prevp = freep) == 0){
 aa4:	e3007bd4 	movw	r7, #3028	; 0xbd4
