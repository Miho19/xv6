...
stat(char *n, struct stat *st)
{
 ...
 234:	eb0000db 	bl	5a8 <fstat>
 238:	e1a04000 	mov	r4, r0
  close(fd);
 23c:	e1a00005 	mov	r0, r5
 240:	eb00008a 	bl	470 <close>
  return r;
}
