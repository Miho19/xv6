   ...
   0:	e3500001 	cmp	r0, #1
{
  ...
  48:	e3001b80 	movw	r1, #2944	; 0xb80
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 758:	e3009b9c 	movw	r9, #2972	; 0xb9c
    neg = 1;
    x = -xx;
...
printf(int fd, char *fmt, ...)
{
 ...
 9e0:	eaffffaf 	b	8a4 <printf+0x50>
          s = "(null)";
 9e4:	e3004bb0 	movw	r4, #2992	; 0xbb0
        while(*s != 0){
...
free(void *ap)
{
 ...
 9f4:	e300cbb8 	movw	ip, #3000	; 0xbb8
...
malloc(uint nbytes)
{
 a90:	e92d48f0 	push	{r4, r5, r6, r7, fp, lr}
  ...
  if((prevp = freep) == 0){
 a94:	e3007bb8 	movw	r7, #3000	; 0xbb8
